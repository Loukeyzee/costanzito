...
const resultExterior1Asset = { url: "/images/results/result-exterior-1.png" };
const resultExterior2Asset = { url: "/images/results/result-exterior-2.png" };
const resultExterior3Asset = { url: "/images/results/result-exterior-3.png" };
const resultExterior4Asset = { url: "/images/results/result-exterior-4.png" };
const resultExterior5Asset = { url: "/images/results/result-exterior-5.png" };
const resultInterior1Asset = { url: "/images/results/result-interior-1.png" };
const resultInterior2Asset = { url: "/images/results/result-interior-2.png" };
const resultInterior3Asset = { url: "/images/results/result-interior-3.png" };
const resultInterior4Asset = { url: "/images/results/result-interior-4.png" };
const resultInterior5Asset = { url: "/images/results/result-interior-5.png" };
